...
def chat():
    ...
    if not GEMINI_API_KEY:
        # 🔥 FORCE FALLBACK CHAT (for demo)
        return jsonify({
            "reply": "Based on your profile, you can focus on software development or data roles. Improve your skills in DSA, SQL, and build projects to increase your job readiness."
        })
